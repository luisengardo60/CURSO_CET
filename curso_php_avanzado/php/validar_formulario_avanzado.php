<!DOCTYPE html>
<html><head><title>Ejemplo validación con JS</title><meta charset="utf-8">
...
if (isNaN(formulario.edad.value)==true || /^[1-9]\d$/.test(formulario.edad.value)==false ) {alert ('Edad no valida. debe ser mayor a 9.'); todoCorrecto=false;}
...
<body><div id="cabecera"><h1>Validación de formularios</h1><h2>Didáctica y divulgación de la programación</h2></div>
